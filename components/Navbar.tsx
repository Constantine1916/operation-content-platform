      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <button onClick={onMenuClick} className="lg:hidden mr-3 p-2 rounded-full text-gray-700 hover:black hover:bg-gray-100 transition-colors">
            ...
            <Link href="/overview" className="flex items-center gap-2">
              ...
              <span className="text-lg font-medium text-gray-800 tracking-[0.15em]">内容运营平台</span>
            </Link>
          </div>
          <div className="flex items-center gap-3">
            <Link href="/" className="text-lg text-gray-600 hover:gray-800 transition-colors tracking-widest uppercase">首页</Link>
          </div>
        </div>
      </div>
    </nav>
