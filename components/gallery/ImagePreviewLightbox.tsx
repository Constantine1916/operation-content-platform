      ...
      >
        <div className={layout.shellClassName}>
          <div className={layout.headerClassName}>
            <div className={layout.headerActionsClassName}>
              <button
                ...
                aria-label="关闭预览"
                onClick={onClose}
                className="inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-black/5 bg-white/92 text-gray-500 shadow-[0_14px_34px_-24px_rgba(15,23,42,0.45)] transition-all duration-200 hover:text-gray-900"
              >
              ...
              <div className={layout.counterClassName}>
          ...
          <div className={layout.stageClassName}>
            <div className="relative flex min-h-[42vh] items-center justify-center overflow-hidden rounded-[30px] border border-black/5 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.96),rgba(243,241,237,0.74)_42%,rgba(232,229,224,0.82)_100%)] px-3 py-5 shadow-[0_28px_70px_-42px_rgba(15,23,42,0.35)]">
              <div className="pointer-events-none absolute inset-x-10 bottom-5 h-16 rounded-full bg-black/5 blur-3xl" />
              ...
              {hasPrev && (
                <button
                  ...
                  className={`absolute left-3 top-1/2 inline-flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-2xl border border-black/5 bg-white/92 text-gray-500 shadow-[0_14px_32px_-24px_rgba(15,23,42,0.4)] transition-all duration-200 hover:text-gray-900 ${layout.floatingControlClassName}`}
                >
                  <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {hasNext && (
                <button
                  ...
                  aria-label="下一张"
                  onClick={() => onSelect(currentIndex + 1)}
                  className={`absolute right-3 top-1/2 inline-flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-2xl border border-black/5 bg-white/92 text-gray-500 shadow-[0_14px_32px_-24px_rgba(15,23,42,0.4)] transition-all duration-200 hover:text-gray-900 ${layout.floatingControlClassName}`}
                >
                  <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="relative z-10 flex max-w-full items-center justify-center px-10">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={item.url}
                  alt={item.prompt}
          ...
          <div className={layout.asideClassName}>
            <div className={layout.contentClassName}>
              ...
              <button
                ...
                className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-2xl border border-gray-200 bg-white px-4 py-3 text-sm font-medium text-gray-800 shadow-[0_12px_28px_-22px_rgba(15,23,42,0.35)] transition-all duration-200 hover:-translate-y-px hover:border-gray-300"
              >
          ...
          <div className={layout.headerClassName}>
            ...
            <div className={layout.headerActionsClassName}>
              <button
                type="button"
                onClick={handleDownload}
                className="inline-flex items-center justify-center gap-2 rounded-2xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-800 shadow-[0_12px_28px_-22px_rgba(15,23,42,0.35)] transition-all duration-200 hover:-translate-y-px hover:border-gray-300"
              >
                <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                </svg>
