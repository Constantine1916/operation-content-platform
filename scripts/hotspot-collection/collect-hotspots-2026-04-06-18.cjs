// Hotspot collection script - 2026-04-06 18:00 UTC (02:00 Beijing April 7)
...
async function main() {
  ...
  const data = {
    ...
    collected_time: TIME,
    timezone: TZ,
    sources: ['hackernews/best', 'aibase/news'],
    items: items,
    hotspots_count: items.length,
    top_categories: cats
  };

  const outPath = `/root/.openclaw/workspace/coding-agent-team/agents/pm/operation-content-platform/data/daily_hotspots/${DATE}_18.json`;
