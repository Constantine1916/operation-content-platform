// Hotspot collection script - 2026-04-06 16:00 UTC (00:00 Beijing April 7)
...
async function main() {
  ...
  const outPath = `/root/.openclaw/workspace/coding-agent-team/agents/pm/operation-content-platform/data/daily_hotspots/${DATE}_16.json`;
