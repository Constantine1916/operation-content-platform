// Hotspot collection script - 2026-04-06 14:00 UTC (22:00 Beijing)
...
async function main() {
  ...
  const outPath = `/root/.openclaw/workspace/coding-agent-team/agents/pm/operation-content-platform/data/daily_hotspots/${DATE}_14.json`;
